...
import {ReactiveJsonRootExperimental} from "../lib/engine/experimental/ReactiveJsonRootExperimental.jsx";
import {stringToBoolean} from "../lib/engine/utility";
import styles from "./Layout.module.css";

export function PageExperimental({buildSourcePath, rjBuildFetchMethod}) {
    ...
    return <ReactiveJsonRootExperimental 
