 ...
 *
 * @param {{args: {data, httpMethod, refreshAppOnResponse, submitSilently, updateOnlyData, updateDataAtLocation, dataMapping, url, allowConcurrent, requestKey}, event, globalDataContext, templateContext}} props Reaction function props.
