...
export class DataStore {
    ...
    notify(changedPath) {
        ...
        // This is potentially expensive if there are many listeners.
        // Optimization: Use a Trie or check only relevant listeners.
        for (const path of this.listeners.keys()) {
            if (path.startsWith(changedPath + ".") && path !== changedPath) {
