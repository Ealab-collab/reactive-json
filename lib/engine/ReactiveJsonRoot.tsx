...
// export const ReactiveJsonRoot = ({children}: MyComponentProps) => {
//     return <div className={styles.div.toString()}>{children}</div>
// }
...
import {stringToBoolean} from "./utility/stringToBoolean";

interface ReactiveJsonRootProps {
    dataFetchMethod?: string,
    dataUrl?: string,
    headersForData?: object,
    plugins?: object,
    debugMode?: boolean,
    DebugModeContentWrapper?: React.ReactElement,
    DebugModeDataWrapper?: React.ReactElement,
    DebugModeRootWrapper?: React.ReactElement,
}
...
export const ReactiveJsonRoot = ({
    ...
    const [rawAppData, setRawAppData] = useState<any>();
